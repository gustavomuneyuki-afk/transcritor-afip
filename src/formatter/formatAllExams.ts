...
import { formatCardiacMuscle } from "./cardiacMuscleFormatter";
import { formatCoagulation } from "./coagulationFormatter";
...
import { formatImmunology } from "./immunologyFormatter";
...
import { formatTumorMarkers } from "./tumorMarkerFormatter";
import { formatUrineProtein } from "./urineProteinFormatter";
import { formatUrinalysis } from "./urinalysisFormatter";

export function formatAllExams(exams: ExamResult): string {
  const groups = [
    ...
    formatVitaminMetabolism(exams.vitaminMetabolism),
    formatImmunology(exams.immunology),
    formatCardiacMuscle(exams.cardiacMuscle),
    formatCoagulation(exams.coagulation),
    formatTumorMarkers(exams.tumorMarkers),
    formatUrineProtein(exams.urineProtein),
    formatUrinalysis(exams.urinalysis),
